    ...
    public class CustomActions : Installer
    {
        ...
        public CustomActions()
        {
            ...
            try
            {
                ...
                regkey = Registry.LocalMachine.OpenSubKey(@"SOFTWARE\Microsoft\VisualStudio\14.0");
                if (regkey == null) regkey = Registry.LocalMachine.OpenSubKey(@"SOFTWARE\Microsoft\VisualStudio\15.0");
