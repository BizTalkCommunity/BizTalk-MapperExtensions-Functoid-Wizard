...
namespace BizTalk.MapperExtensions.Functoid.Wizard
{
    ...
    public class FunctoidProjectWizard : IDTWizard
    {
        ...
        private string _functoidFunctionName = "FunctionName";
		...
		public void CreateSolution(_DTE IDEObject,object[] contextParams)
		{
            ...
            _solutionDirectory = _projectDirectory.Substring(0, _projectDirectory.LastIndexOf('\\'));
            ...
            _functoidFunctionName = (string)_wizardResults[WizardValues.FunctoidFunctionName];
            ...
            _resourceTemplate.FunctionName = _functoidFunctionName;
			...
			else
			{
                ...
                _functoidSolution.Create(_solutionDirectory, _solutionName);
            }
			...
			_functoidSolution.SaveAs(_solutionDirectory + "\\" + _solutionName + ".sln");
			#endregion
		}
		...
		public void CreateFunctoidProject()
		{
            ...
            { 
                ...
                Directory.CreateDirectory(FunctoidDirPath + "\\Properties");
            }
			...
			_resourceTemplate.RenderAndAddToProject("AssemblyInfo." + extension,
				"AssemblyInfo." + extension.Replace("$",""), relativePath + ".Properties", FunctoidDirPath + "\\Properties", FunctoidVSProject, false);
			...
			_resourceTemplate.RenderResourceFileAndAddToProject(_className + "Resources.resx", FunctoidDirPath, FunctoidVSProject, true);
